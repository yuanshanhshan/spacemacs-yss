...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(rust
     ...
     ;; Unco mment some layer names and press `SPC f e R' (Vim style) or
